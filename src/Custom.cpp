...
void Custom::sortPictures(Loader& data) {
    ...
    // Sort the pictures using the rank (specified in the function above)
    ...
    // Iterate over all pictures in the vector until the max width is reached
...
void Custom::runCustom(Loader &data) {
    ...
    // After sorting and finding rank combination,
